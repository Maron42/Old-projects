...
----------
""")
MAX_WRONG = len(HANGMAN) - 1 #Why (-1)? Because empty gallows - first element
#and it must be on the screen.
WORDS = ("OVERUSED" , "PYTHON" , "GOD BLESS YOU" , "WATCH" , "SIMPLE" , "DOG" , "FORBES" , "ELON MUSK")
